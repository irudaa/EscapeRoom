...
public class RoomFour extends JPanel{
    ...
    public RoomFour(JFrame frame, InventoryView inv) {
        ...
        number = new JLabel(new ImageIcon(new ImageIcon("src/Images/number7.png").getImage()));
        setRoomFour();
    }
    ...
    public void setRoomFour(){
        ...
        //Switch for the room
        switchLight = new Switch();

        //put number
        number.setBounds(850, 180, number.getWidth() + 150, number.getHeight() + 150);
        ...
        room.add(switchLight.getClosedSwitchLabel(), new Integer(1));
    ...
    public Point getNumberPoint(){ return new Point(number.getX(), number.getY());}
